...
void iniciar_esi(){
	...
	log_info(log_esi, "SOCKET_COORDINADOR: %d", SOCKET_COORDINADOR);

	log_info(log_esi, "SOCKET_PLANIFICADOR: %d", SOCKET_PLANIFICADOR);

	informar_conexion_exitosa_a(SOCKET_COORDINADOR);

	informar_conexion_exitosa_a(SOCKET_PLANIFICADOR);
